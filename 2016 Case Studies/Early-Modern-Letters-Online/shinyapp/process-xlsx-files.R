...
data.dir <- "/Users/martinjohnhadley/Dropbox/Live-Data/Arno-EMLO/original-xlsx-files/initial-focus"
...
master_life_event_sheets <- c("Event.Label" = character(),
                             "Category" = character(),
...
## Export to csv
write.csv(master_life_events_sheets,"master_life_events_sheet.csv", na = "", row.names = FALSE)
